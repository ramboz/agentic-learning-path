...
- [**Geoffrey Huntley on CLAUDE.md and rules**](https://ghuntley.com/). Practitioner notes on when rules earn their keep and when one CLAUDE.md is still the right answer. Concrete examples.
- [**Simon Willison on agentic coding workflows**](https://simonwillison.net/tags/claude-code/). Ongoing notes that include rule and skill examples from real projects, and the rules-vs-skills boundary as it shows up in practice.
