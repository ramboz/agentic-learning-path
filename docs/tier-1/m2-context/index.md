...
- [**"How to Fix Your Context" (Willison)**](https://simonwillison.net/2025/Jun/29/how-to-fix-your-context/). Names the four context-rot failure modes: poisoning, distraction, confusion, clash. Maps directly to the "Claude forgot vs. never had it" framing.
- [**"if you are redlining the LLM, you aren't headlining" (Huntley)**](https://ghuntley.com/redlining/). Concrete numbers behind the degradation curve: quality drops well before the advertised 200k window fills. Practitioner counterweight to "Lost in the Middle."
